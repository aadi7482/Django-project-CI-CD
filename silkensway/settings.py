"""
Django settings for silkensway project.
...
SECRET_KEY = 'django-insecure-r*wg2oh+%jq)=pywy@p7+#u)yju@ali5*ka#k^^g#%9c_-gb42'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["lms.blueappleonline.com"]
...
WSGI_APPLICATION = 'silkensway.wsgi.application'
